...
let createFullNetworkNeighbours(nodes:list<IActorRef>, index:int, numofNodes:int) =
...
// Line Topology
// Linear topology
let createLineNeighbours(nodes: IActorRef list , index:int) =
...
let create2DNeighbours (nodes:list<IActorRef>, index:int, side:int, isImproper:bool) =
    let mutable arrayNeighbor = []
...
let create3DNeighbours(nodes:list<IActorRef>, index:int, side:int, layerSize:int, numNodes:int, isImproper:bool) =
    let mutable arrayNeighbor = []
